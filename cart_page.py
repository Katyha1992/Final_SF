...
class CartPage(BasePage):
    # Метод проверки, что на странице корзины содержится добавленный товар
    ...
    # Метод проверки, что кнопка "очистить корзину" удаляет содержимое корзины
    ...
    # Метод проверки, что кнопка "оформить заказ" ведет на страницу оформления заказа
