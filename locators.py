...
class BasePageLocators():
    ...
    NOVINKI_LINK = (By.CSS_SELECTOR, ".ty-menu-item__newest bdi")
    NOVINKI_LINK_OPEN = (By.CSS_SELECTOR, 'a[href="https://besttea.ru/noviepostupleniya/"]')
    SALE_LINK = (By.CSS_SELECTOR, ".ty-menu-item__sale bdi")
    SALE_LINK_OPEN = (By.CSS_SELECTOR, 'a[href="https://besttea.ru/sale/"]')
...
class SearchPageLocators():
    ...
    BUY_BUTTON = (By.CSS_SELECTOR, '#button_cart_6850')
