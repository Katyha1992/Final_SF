...
class SearchPage(BasePage):
    ...
    # Метод проверки, что при вводе товара в поисковую строку на странице выводится найденный товар
    ...
    # Метод проверки, что на странице видна информация о количестве найденного товара
    ...
    # Метод проверки, количество товара на странице совпадает с количеством в тексте: "Найдено товаров ..."
    ...
    # Мтод проверки, что при вводе товара (с негативным сценарием) в поисковую строку на
    ...
    # Метод проверки, что на иконке "Корзина" появляется число количество добавленного товара
    def should_be_the_number_of_the_added_product_appears_on_the_Cart_icon(self):
        search_input = self.find_element(BasePageLocators.SearchLokators.SERCH_INPUT)
        search_input.clear()
        search_input.send_keys("подставка")
        button_search = self.find_element(BasePageLocators.SearchLokators.BUTTON_SERCH)
        button_search.click()
        display_button = self.find_element(SearchPageLocators.COLUMN_DISPLAY_BUTTON)
        display_button.click()
    ...
    # Метод проверки, что во вкладке корзины присутствует добавленный товар
